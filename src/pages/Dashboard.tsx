...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8">
      <PageHead title="Dashboard | ListPro.AI" description="Overview of your multi-platform listings, recent activity, and key inventory stats across Facebook, Poshmark, and eBay." path="/" />
      {/* Header */}
      <div>
